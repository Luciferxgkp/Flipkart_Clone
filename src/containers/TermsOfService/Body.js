      ...
      <div className="h-max flex w-auto md:w-[60%] lg:w-[70%] items-center">
        ...
        >
          <div className="flex flex-col gap-4">
            <div className="text-[16px] font-extrabold">Overview</div>
            <div>
              This Website is operated by{" "}
              <span className="text-primary">Bazzar (Pvt) Ltd</span>. Throughout
              the site, the terms “we”, “us” and “our” refer to Bazzar (Pvt)
              Ltd. Bazzar (Pvt) Ltd offers this website, including all
            ...
            <div className="flex flex-col gap-2">
              ...
              <div>
                You agree to indemnify, defend and hold harmless our directors,
                officers, employees, affiliates, agents, contractors, interns,
                suppliers, service providers and licensors harmless from any
                indemnification demand, loss, liability, claim or demand,
